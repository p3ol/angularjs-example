angular
  ...
  .component('premium', {
      ...
      <div class="page premium">
        <div class="container">
          ...
          <div class="articleBody">
            ...
            <p>You liked this post ? Try <a ng-href="/free">this one</a>.</p>
          </div>
          <div ng-if="!$ctrl.isUserPremium()" id="poool-widget"></div>
        </div>
      </div>
    `,
    controller: class PremiumCtrl {
      ...
      $onInit() {
        poool('event', 'onSubscribeClick', this.onSubscribeClick);
        this.sendHit();
      }

      onSubscribeClick() {
        this.$timeout(() => this.$location.path('/subscribe'));
      }
      ...
      $onDestroy() {
        poool('unevent', 'onSubscribeClick', this.onSubscribeClick);
      }
    },
  });
